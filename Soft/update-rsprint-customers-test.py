...
companyNamesToId = { 'go4d': 9, 'superfeet': 10 }
...
url = 'https://rsscan-identityserver-test.azurewebsites.net/connect/token'
data = {
...
url = 'https://rsscan-customerservice-test.azurewebsites.net/api/v1/rsprint-customers'
